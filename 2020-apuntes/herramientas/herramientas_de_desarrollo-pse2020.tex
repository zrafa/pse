...
\abstract{La programación de sistemas embebidos, en una visión conceptual de alto nivel, 
no es muy diferente de la programación realizada en PC o computadoras
de propósito general. Lo único que realmente cambia en el proceso es 
...
son diferentes. Por ejemplo, el método de comunicación
...
agrega una gran cantidad de complejidad adicional, y es también la razón
...
del software para la ejecución en un sistema embebido, y de las
...
Nos enfocaremos en el uso de herramientas open source provistas por 
GCC (GNU Compiler Collection), las son parte del proyecto GNU.
