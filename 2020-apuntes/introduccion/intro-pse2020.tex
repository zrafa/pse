...
del hardware de la computaodra de un sistema embebido.
Toda la columna de la derecha son periféricos internos al chip,
y se utilizan para interconectar dispositivos externos. En nuestro ejemplo
