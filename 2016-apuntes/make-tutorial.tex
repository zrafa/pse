...
Recuerde que la sintaxis para reglas es que luego de
especificar el objetivo y los prerequisitos las recetas 
de construcción comienzan con un TAB. Si al copiar y pegar encuentra problemas con make
se debe verificar que los espacios en las recetas comienzan con una caracter TAB.
\vspace*{0.4cm} } }
