...
\fancypagestyle{plain}{\fancyhf{}}
  	\pagestyle{fancy}
 	\lhead{\footnotesize Compilación, vinculación y localización - Departamento de Ingeniería de Computadoras}
...
Si el bootloader no recibe ordenes desde el puerto serial ejecuta la aplicación
actual en FLASH.
\vspace*{0.4cm} } }
...
UNIX (shell) serán indicados por el símbolo numeral (\#). 
\vspace*{0.4cm} } }
