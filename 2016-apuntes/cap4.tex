...
\fancypagestyle{plain}{\fancyhf{}}
  	\pagestyle{fancy}
 	\lhead{\footnotesize Compilacion, vinculacion y localizacion - Departamento de Ingeniería de Computadoras}
...
\fcolorbox{black}{grey}{
\parbox[t]{1.0\linewidth}{ \vspace*{0.4cm}
NOTA: Este último procedimiento realizado por ld es unicamente para vinculación
...
existe un bootloader provisto por el proyecto Arduino que es ejecutado
primero.
Esta pieza de software que se ejecuta primero puede ser utilizado
para descargar software, y ubicar el mismo en la memoria FLASH, dirección 0x00.
Si el bootlodaer no recibe ordenes desde el puerto serial ejecuta la aplicación
actual en FLASH.
\vspace*{0.4cm} } }
...
\fcolorbox{black}{grey}{
\parbox[t]{1.0\linewidth}{ \vspace*{0.4cm}
NOTA: Los comandos que deben ser ejecutados desde un interprete de comandos
UNIX (shell) serán indicados por el simbolo numeral (\#). 
\vspace*{0.4cm} } }
